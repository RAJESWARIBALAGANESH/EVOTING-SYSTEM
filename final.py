...
def show_results():
    ...
    bg_image_path = "D://project//rbg.jpg"  # Change this to your actual image path
...
def voting_window(username):
    ...
    # Load background image
    bg_image_path = "C:\\Users\\RAJESWARI\\Downloads\\vbg1.jpg"  # Change this to your actual background image path
    bg_image = Image.open(bg_image_path)
    ...
    party_images = ["C:\\Users\\RAJESWARI\\Downloads\\tvk.jpg",
                    "C:\\Users\\RAJESWARI\\Downloads\\dmk.png",
                    "C:\\Users\\RAJESWARI\\Downloads\\admk.jpg",
                    "C:\\Users\\RAJESWARI\\Downloads\\nota.jpg"]
...
# Load background image
bg_image_path = "C://Users//RAJESWARI//Downloads//lbg.jpg"  # Change this to your actual image path
bg_image = Image.open(bg_image_path)
